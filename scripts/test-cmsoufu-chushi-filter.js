...
//
// 背景（2026-07-08）:
//   6月末で中止した利用者112が、中止登録した途端に6月の一覧から消えた。
...
// --- 利用者112: 最終利用日 2026-06-30 ---
const hirano = { status: '中止', lastUseDate: '2026-06-30' };
eq(hidden(hirano, '2026-06'), false, '利用者112: 6月は出す（実績送付義務あり）');
eq(hidden(hirano, '2026-07'), true,  '利用者112: 7月は出さない');
eq(hidden(hirano, '2026-05'), false, '利用者112: 5月は出す');
