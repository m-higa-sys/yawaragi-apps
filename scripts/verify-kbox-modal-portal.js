...
const kbState = {
  items: [{ name: '根岸君男', email: 'utsukushinosato.pc36@gmail.com', cmStaff: '大野勝己', cmOffice: '居宅介護支援事業所梨花', care: '要介護', unit: '午後', date: '2026-07-07', reason: '私用', toOverride: '', customBody: '', cls: { kind: 'mail', done: false } }],
  checked: { '根岸君男': true },
};
