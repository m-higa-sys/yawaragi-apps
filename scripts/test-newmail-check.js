...
// ===== nmDedupeItems_（2026-07-14追加）: 同一メールの重複表示を1件に畳む =====
// Gmailのスレッド→メッセージ二重ループで、同一件名メールが同スレッドにまとまると
// 同じ内容が複数回 push される。from+subject+date（分単位）が完全一致するものを先勝ちで1件に。
console.log('[nmDedupeItems_]');
const dedupe = F.nmDedupeItems_;
eqJson(dedupe([
  { from: 'post_master@netbk.co.jp', subject: '定額自動振込サービス振込受付のお知らせ', date: '2026-07-14 02:34' },
  { from: 'post_master@netbk.co.jp', subject: '定額自動振込サービス振込受付のお知らせ', date: '2026-07-14 02:34' }
]), [
  { from: 'post_master@netbk.co.jp', subject: '定額自動振込サービス振込受付のお知らせ', date: '2026-07-14 02:34' }
], '完全重複2件 → 1件（住信SBIの実例・先勝ち）');

eqJson(dedupe([
  { from: 'system@job-medley.com', subject: 'メッセージが届きました', date: '2026-07-13 09:05' },
  { from: 'system@job-medley.com', subject: 'メッセージが届きました', date: '2026-07-13 11:47' },
  { from: 'system@job-medley.com', subject: 'メッセージが届きました', date: '2026-07-13 15:56' }
]), [
  { from: 'system@job-medley.com', subject: 'メッセージが届きました', date: '2026-07-13 09:05' },
  { from: 'system@job-medley.com', subject: 'メッセージが届きました', date: '2026-07-13 11:47' },
  { from: 'system@job-medley.com', subject: 'メッセージが届きました', date: '2026-07-13 15:56' }
], 'date違いは別メールとして全部残る（ジョブメドレー同件名別時刻）');

eqJson(dedupe([
  { from: 'a@x.com', subject: 'S', date: '2026-07-14 02:34' },
  { from: 'b@x.com', subject: 'S', date: '2026-07-14 02:34' }
]), [
  { from: 'a@x.com', subject: 'S', date: '2026-07-14 02:34' },
  { from: 'b@x.com', subject: 'S', date: '2026-07-14 02:34' }
], 'from違いは両方残る');
...
eqJson(dedupe([
  { from: 'a@x.com', subject: 'S1', date: '2026-07-14 02:34' },
  { from: 'a@x.com', subject: 'S2', date: '2026-07-14 02:34' }
]), [
  { from: 'a@x.com', subject: 'S1', date: '2026-07-14 02:34' },
  { from: 'a@x.com', subject: 'S2', date: '2026-07-14 02:34' }
], 'subject違いは両方残る');

eqJson(dedupe([]), [], '空配列 → 空配列');

eqJson(dedupe([
  { from: 'system@job-medley.com', subject: '応募', date: '2026-07-13 08:57', matchedBy: ['domain:job-medley.com', 'subject:応募'] },
  { from: 'system@job-medley.com', subject: '応募', date: '2026-07-13 08:57', matchedBy: ['domain:job-medley.com', 'subject:応募'] }
]), [
  { from: 'system@job-medley.com', subject: '応募', date: '2026-07-13 08:57', matchedBy: ['domain:job-medley.com', 'subject:応募'] }
], 'matchedBy付きの重複も1件に（先勝ちで属性保持）');
