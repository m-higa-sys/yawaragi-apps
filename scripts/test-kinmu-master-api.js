...
// ===== 31. 固定勤務パターンが API に出る =====
{
  ...
  eq('固定勤務パターンが構造化されて返る', higa.固定勤務パターン,
    { raw: '40h / 08:00-17:00 × 週5日', 週時間: 40, 開始: '08:00', 終了: '17:00', 週日数: 5 });
...
// ===== 34. 2026-08-07 の確定値 =====
{
  ...
  // 2026-08-07 社長確認で確定した実値をここで固定する
  eq('固定勤務パターンの確定値', h['固定勤務パターン'], '40h / 08:00-17:00 × 週5日');
  eq('構造化すると 08:00-17:00 週5日', ctx.parseFixedPattern_(h['固定勤務パターン']),
    { raw: '40h / 08:00-17:00 × 週5日', 週時間: 40, 開始: '08:00', 終了: '17:00', 週日数: 5 });
  ok('9h拘束 − 休憩1h = 8h/日 × 週5日 = 40h で週所定と整合',
    (17 - 8 - 1) * 5 === h['週所定時間']);
}
