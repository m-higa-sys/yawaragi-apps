...
// R1-R2: abUniquePresent_ が各出席者に session:'am'|'pm' を付与
var attR = { attendance: {
  am: [{ name: '午前男', status: '出席', care: '要介護1' }, { name: '午前欠席子', status: '欠席' }],
  pm: [{ name: '午後子', status: '出席', care: '要支援2' }]
}};
var presR = core.abUniquePresent_(attR);
...
var presR2 = core.abUniquePresent_({ attendance: {
  am: [{ name: '両単位子', status: '欠席', care: '' }],
  pm: [{ name: '両単位子', status: '出席', care: '要介護2' }]
}});
...
var presR3 = core.abUniquePresent_({ attendance: {
...
// R8-R10: abIntersectPresent_ が出席者のsessionを業務hit行へ載せる（順序保持・非破壊）
var tgtR = [{ name:'午前男', key:'午前男', care:'要介護1' }, { name:'午後子', key:'午後子', care:'要支援2' }];
var interR = core.abIntersectPresent_(tgtR, presR);
...
// R11-R18: abBuildBoard_ の presentAm/presentPm・恒等・行session・residue session・ampmConflict
var inR = {
  year:2026, month:7, today:'2026-07-20',
  attendance:{ attendance:{
...
var bR = core.abBuildBoard_(inR, { isHyoukaMonth: isHyoukaMonth, oralCycleAt: oralCycleAt });
...
// R19-R20: 衝突ありのabBuildBoard_は1名カウント＋ampmConflictに名指し可視化
var bRc = core.abBuildBoard_({
  year:2026, month:7, today:'2026-07-20',
  attendance:{ attendance:{
