...
// ★プロトタイプ汚染耐性: 系統が 'constructor' でも落ちない（kasanGroupBySection と対称）
ok((function(){ try { c.kasanSplitKeitou([{keitou:'constructor', code:'X'}]); return true; } catch(e){ return false; } })(),
   "★keitou='constructor' でも例外にならない");
eq(c.kasanSplitKeitou([{keitou:'constructor', code:'X'}])['系統不明'].length, 1,
   "★keitou='constructor' は「系統不明」へ");
