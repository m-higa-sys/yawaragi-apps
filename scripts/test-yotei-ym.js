...
sec('ymCandidates — 月タップの候補（当月から12個・過去月を出さない）');
eq(Y.ymCandidates('2026-07', 12),
  ['2026-07', '2026-08', '2026-09', '2026-10', '2026-11', '2026-12',
   '2027-01', '2027-02', '2027-03', '2027-04', '2027-05', '2027-06'],
  '当月2026-07から12個（翌年6月まで）');
eq(Y.ymCandidates('2026-07', 12).length, 12, '個数はちょうど12');
eq(Y.ymCandidates('2026-07', 12)[0], '2026-07', '先頭は当月（＝対象に戻せる）');
ok(Y.ymCandidates('2026-07', 12).every(function (m) { return m >= '2026-07'; }), '過去月が1つも含まれない');
eq(Y.ymCandidates('2026-12', 12),
  ['2026-12', '2027-01', '2027-02', '2027-03', '2027-04', '2027-05',
   '2027-06', '2027-07', '2027-08', '2027-09', '2027-10', '2027-11'],
  '年跨ぎ: 当月12月なら翌年11月まで並ぶ');
eq(Y.ymCandidates('2026-01', 12)[11], '2026-12', '1月始まりは同年12月で終わる');
eq(Y.ymCandidates('', 12), [], '解釈不能は空配列（壊れない）');
eq(Y.ymCandidates('2026-07', 0), [], '個数0は空配列');
eq(Y.ymCandidates('2026-07'), Y.ymCandidates('2026-07', 12), '個数省略時の既定は12');
