...
var LAUNCHER_MAPPING = {
  ...
  // 測定管理（予定月スライド方式・2026-07-28 登録）。今まで month-board からのリンクしか無く
  // 現場から辿り着けなかったのが「誰も使っていない」の直接原因だったため、ランチャーに載せる。
  // アイコンは 📐。指示書は 📏 だったが height（身長チェック）が既に 📏 を使っており、
  // 同じカテゴリ内で絵文字が重なると現場が見分けられないため変更した。
  'sokutei':        { cat:'利用者の記録', icon:'📐', name:'測定管理', order:7 },
