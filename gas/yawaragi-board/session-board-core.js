...
var SB_PDF_DOC_WORDS = {
  ...
  // ★2026-08-08 実測: 現場が実際に置いている名前は「7月通所介護評価・◯◯.pdf」。
  //   語彙に「通所介護評価」が無く、氏名は当たるのに書類名が読めず weak 止まりだった（8件）。
  //   足すのはこの1語だけ。既存3語はそのまま残す（過去のファイル名を落とさない）。
  tsusho_hyouka:  ['通所評価', '結果報告書', '評価表', '通所介護評価'],
